...
export type MDXContentAction =
  ...
  | { type: MDXContentActionEnum.SET_SELECTED_BODY_CONTENT_TYPE; payload: string }
  | { type: MDXContentActionEnum.SET_SELECTED_RESPONSE_CONTENT_TYPE; payload: string }
  | {
...
export const MDXContentReducer: Reducer<MDXContentState, MDXContentAction> = (
  ...
  console.debug(MDXContentActionEnum[type], action.payload);
  switch (type) {
    ...
    case MDXContentActionEnum.SET_SELECTED_BODY_CONTENT_TYPE:
      return {
        ...state,
        selectedBodyContentType: action.payload,
      };
    case MDXContentActionEnum.SET_SELECTED_RESPONSE_CONTENT_TYPE:
      return {
        ...state,
        selectedResponseContentType: action.payload,
      };
    case MDXContentActionEnum.SET_API_PLAYGROUND:
      const { apiPlaygroundMode, api, generatedRequestExamples } = action.payload;
      return {
        ...state,
        apiPlaygroundMode,
        api,
...
MDXContentContext.displayName = ContextDisplayNameEnum.MDXContentContext;
