...
import IntegrationsScripts from '@/analytics/scripts/IntegrationsScripts';
...
export default function SupremePageLayout({
  ...
  const { mintConfig, navWithMetadata, pageMetadata, openApiFiles, apiReferenceData } = pageData;
  ...
  const metaTagsDict = getAllMetaTags(
    pageMetadata,
    mintConfig,
    getOGImageEndpoint(origin, pageMetadata, mintConfig, navWithMetadata, router.asPath)
  );
