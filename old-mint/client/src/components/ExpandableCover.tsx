...
function ExpandableCover({
  ...
  return (
    <button
      ...
      className={`not-prose mt-3.5 flex flex-row items-center content-center w-full py-1 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 ${
        !open ? 'rounded-b-xl' : ''
      }`}
