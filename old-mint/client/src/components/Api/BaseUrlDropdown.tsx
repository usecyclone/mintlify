export function BaseUrlDropdown({
  ...
  return (
    <div className="border-gray-400 dark:border-gray-400 relative select-none align-middle inline-flex rounded-md -top-px mx-1 w-5 h-[1.125rem] bg-white hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-600 border hover:border-gray-400 dark:hover:border-gray-400 focus:outline-none cursor-pointer">
      <select
      ...
      >
        <path
          className="stroke-gray-700 dark:stroke-gray-100"
          d="M9 7l3 3-3 3"
          strokeWidth="1.5"
          strokeLinecap="round"
