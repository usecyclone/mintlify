    ...
    <DynamicLink
      ...
      className={clsx(
        ...
        isActive
          ...
          : 'font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300'
      )}
    >
      <div
        style={
        ...
        className={clsx(
          ...
          isActive
            ? [color ? '' : 'bg-primary']
            : 'zinc-box group-hover:brightness-100 group-hover:ring-0 ring-1 ring-gray-950/5 dark:ring-gray-700/40'
        )}
      >
        {icon}
      </div>
