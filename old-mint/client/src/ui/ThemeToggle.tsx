...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <div className="bg-gray-200/60 dark:bg-white/10 rounded-full absolute left-0 right-0 h-[0.65rem] top-1/2 translate-y-[-50%]"></div>
      <span className="sr-only">Switch theme</span>
      <span
        aria-hidden="true"
        className="translate-x-0 dark:translate-x-2.5 shadow shadow-gray-700/10 border border-gray-200 bg-background-light dark:border-primary dark:bg-background-dark p-[3px] pointer-events-none inline-block h-5 w-5 transform rounded-full ring-0 transition-transform duration-200 ease-in-out"
      >
        <SunIcon />
        <MoonIcon />
      </span>
